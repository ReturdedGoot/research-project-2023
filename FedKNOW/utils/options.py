...
def args_parser():
    ...
    parser.add_argument('--local_test_bs', type=int, default=50, help="the batch size for local test")
    ...
    parser.add_argument('--download', action='store_true', help="download the dataset passed as argument")
    ...
    parser.add_argument('--labelType', type=str, choices = {"coarse","fine","finecoarse",""}, default='coarse', help="coarse or fine labels. Only applicable for cifar100")
    parser.add_argument('--root', type=str, default='data/cifar100', help="path to the cifar100 dataset")
    parser.add_argument('--iid', action='store_true', help='whether i.i.d or not')
    parser.add_argument('--num_classes', type=int, default=100, help="number of classes")
    parser.add_argument('--num_channels', type=int, default=3, help="number of channels of imges")
    parser.add_argument('--gpu', type=int, default=0, help="GPU ID, -1 for CPU")
    parser.add_argument('--seed', type=int, default=1, help='random seed (default: 1)')
    parser.add_argument('--exp_name', type=str, default='', help='additional name for experiment while savong logs and data')
    ...
    parser.add_argument('--partitioning', type=str, choices={"","unique", "column", "balanced", "shuffled"}, default="", help='Use repo\'s mechanism(by default) or row-wise (row), column-wise(column), or balanced(balanced)')
    ...
    parser.add_argument('--softmaxtype', choices={"expanding", "sliding", "full"}, default="sliding", help="The sliding window type of softmax layer")
